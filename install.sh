...
echo ""
echo "One manual step left: Open Terminal > Settings > Profiles > Text and set the font to 'Hack Nerd Font (needed for Starship's icons to render) and restart your terminal."